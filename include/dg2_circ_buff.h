...
static inline size_t dg2_circ_buff_get_capacity(const dg2_circ_buff *circ_buff)
{
...
size_t dg2_circ_buff_copy(dg2_circ_buff *circ_buff, uint8_t *dest, size_t size); // Todo: Restrict

size_t dg2_circ_buff_read(dg2_circ_buff *circ_buff, uint8_t *dest, size_t size); // Todo: Restrict

uint8_t dg2_circ_buff_push(dg2_circ_buff *circ_buff, uint8_t data);

size_t dg2_circ_buff_write(dg2_circ_buff *circ_buff, const uint8_t *src, size_t size); // Todo: Restrict
